        ...
        <div class="dropdown">
          ...
          <div class="dropdown-box w-40">
            <div class="dropdown-box__content box dark:bg-dark-1 p-2">
              ...
              >
                <PrinterIcon class="w-4 h-4 mr-2" /> In
              </a>
              <a
                href=""
                class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
              >
                <FileTextIcon class="w-4 h-4 mr-2" /> Xuất file Excel
              </a>
              <a
                href=""
                class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
              >
                <FileTextIcon class="w-4 h-4 mr-2" /> Xuất file PDF
              </a>
            </div>
          </div>
        </div>
        <div class="hidden md:block mx-auto text-gray-600">
          Hiển thị từ 1 đến 10 trong tổng số 150 bản ghi
        </div>
        ...
        <table class="table table-report -mt-2">
          <thead>
            <tr>
              ...
              <th class="text-center whitespace-no-wrap">THAO TÁC</th>
            </tr>
          </thead>
          <tbody>
            <tr
